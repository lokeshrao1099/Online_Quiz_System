...
INSERT IGNORE INTO tests (id, teacher_id, title, description, time_limit_minutes, max_attempts) VALUES
(1, 1, 'Java OOP Basics', 'Sample test for students.', 10, 1);

INSERT IGNORE INTO questions (id, test_id, question, option_a, option_b, option_c, option_d, correct_answer) VALUES
